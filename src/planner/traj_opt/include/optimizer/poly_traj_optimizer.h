  ...
  private:
    ...
    void setDesiredFormation(int type){
      ...
      switch (type)
      {
        ...
        case FORMATION_TYPE::SYSU :
        {
          // set the desired formation
          // relative_pos_0 : {x: -23.5, y: 1.5, z: 0.0},
          // relative_pos_1 : {x: -25, y: 2.5, z: 0.0},
          // relative_pos_2 : {x: -26.5, y: 1.5, z: 0.0},
          // relative_pos_3 : {x: -26.5, y: 0.5, z: 0.0},
          // relative_pos_4 : {x: -23.5, y: -0.5, z: 0.0},
          // relative_pos_5 : {x: -23.5, y: -1.5, z: 0.0},
          // relative_pos_6 : {x: -25, y: -2.5, z: 0.0},
          // relative_pos_7 : {x: -26.5, y: -1.5, z: 0.0}
          Eigen::Vector3d v0(0.0, 0.0, 0.0);
          Eigen::Vector3d v1(0.0, 0.0, 0.0);
          Eigen::Vector3d v2(0.0, 0.0, 0.0);
          Eigen::Vector3d v3(0.0, 0.0, 0.0);
          Eigen::Vector3d v4(0.0, 0.0, 0.0);
          Eigen::Vector3d v5(0.0, 0.0, 0.0);
          Eigen::Vector3d v6(0.0, 0.0, 0.0);
          Eigen::Vector3d v7(0.0, 0.0, 0.0);
